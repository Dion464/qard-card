  ...
  return (
    <section className="w-full min-h-[90vh] sm:min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-start">
        <div className="container mx-auto px-4 sm:px-8 flex flex-col">
          ...
          <div className="mt-16 sm:mt-48 mb-2 sm:mb-8">
            <div className="text-[60px] sm:text-[120px] md:text-[200px] lg:text-[320px] font-[500] leading-[0.85] tracking-[-0.02em] bg-gradient-to-r from-black via-[#50ABFF] to-[#50ABFF]/90 bg-clip-text text-transparent">
              Qard.
            </div>
            <div className="text-[40px] sm:text-[80px] md:text-[120px] lg:text-[200px] font-[500] leading-[0.85] tracking-[-0.02em] text-[#50ABFF]/70 w-full">
              Your wallet.
            </div>
          </div>
        </div>
      ...
      <div className="absolute top-[60vh] left-4 sm:top-48 sm:right-8 sm:left-auto max-w-[90%] sm:max-w-[380px]">
        <p className="text-white text-lg sm:text-2xl md:text-3xl font-light mb-1 sm:mb-3">From $45</p>
        <p className="text-[#6B7280] text-xs sm:text-base md:text-lg font-light leading-relaxed">
        ...
        <button className="mt-2 sm:mt-8 bg-transparent border border-[#50ABFF] text-[#50ABFF] px-3 sm:px-6 py-1 sm:py-2 rounded-full text-xs sm:text-base font-light inline-flex items-center hover:bg-[#50ABFF]/10 transition-all">
          Try Qard 
