...
export default function Search() {
  return (
    <div className="min-h-[500px] bg-[#0A1825] relative overflow-hidden px-4 sm:px-6 md:px-8 py-10">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 relative">
        {/* Left side with text and search */}
        <div className="col-span-1 z-10 pt-12 md:pt-24 pb-52 md:pb-0">
          <h1 className="text-white text-[32px] sm:text-[42px] md:text-[52px] font-medium mb-6 leading-[1.1]">
        ...
        <div className="absolute right-0 bottom-0 md:top-0 w-full md:w-[75%] h-48 md:h-full">
          <Image
            ...
            width={500}
            height={300}
            className="absolute -right-16 sm:-right-32 md:-right-96 bottom-0 md:top-10 w-[400px] sm:w-[600px] md:w-[1100px]"
            priority
          />
        </div>
      </div>
